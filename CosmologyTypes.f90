...
! MagCosmoMC: choosing the type of magnetic contributions one wants to calculate
        ...
        !Helical contribution, YUN
     !do_helical moved to power_tilt_mag
        logical :: do_helical = .false.  
...
! MagCosmoMC: adding the new parameters
        ...
        real(mcp):: helical_amp, helical_ind !helical yun
!-------
...
!MagCosmoMC: reading which magnetic modes to compute
   ...
   this%tensor_passive	= Ini%Read_Logical('tensor_passive',.false.)
     ! YUN !Helical Contribution 
   this%do_helical = Ini%Read_Logical('do_helical', .false.)
   this%maximal_hel = Ini%Read_Logical('maximal_hel', .true.)
!-----------------
